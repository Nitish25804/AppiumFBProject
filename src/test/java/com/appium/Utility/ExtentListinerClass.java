...
public class ExtentListinerClass implements ITestListener {
	...
	public void configureReport()
	{
		...
		reports.setSystemInfo("Machine:", "Mobile");
		reports.setSystemInfo("OS", "Android");
		//reports.setSystemInfo("browser:",readConfig.getBrowser());
		reports.setSystemInfo("user name:", "Nitish");
		reports.setSystemInfo("Automation Tools","Appium");
